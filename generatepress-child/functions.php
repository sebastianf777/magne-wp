...
$output = '<ul>';
    ...
    // Add a unique ID for the code
    $output .= '<li id="code-' . esc_attr($code) . '">'
        . esc_html($code) . ': <span class="count">' . esc_html($count) . '</span> '
        . 'People Have Accessed the ' . esc_html($message)
        . '</li>';
    }
    } else {
...
echo '<div class="updated">
    <p>Reset successful! ' . esc_html($deleted_rows) . ' entries removed for code: ' . esc_html($code_to_reset) . '</p>
</div>';
} else {
echo '<div class="error">
    <p>Please enter a valid code to reset.</p>
</div>';
}
}
